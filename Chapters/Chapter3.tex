...
\noindent La HAL esta compuesta de:
\begin{itemize}
\item Hardware:
	\begin{itemize}
...
\item Board Drivers:
	...
	\item bq.c : Implementa las funciones de lectura de estado y control del bq24080.
...
Similarmente, esta es la abstracción para el circuito controlador de carga:
