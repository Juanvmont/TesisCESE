...
Se optó por no hacer tal cosa, consumo del circuito por


Para ver una descripción mas detallada del firmware en pseudocódigo y sus principales funciones, ver \ref{AppendixB}.
...
Las topologías posibles de implementar son las siguientes \citep{802154}:
\begin{figure}[h!]
	\centering
