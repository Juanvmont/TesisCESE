...
El diagrama de Gantt, es otra herramienta de planificación que ofrece una información mas detallada de los tiempos, recursos y subtareas de un proyecto. Para realizarlo se utilizó la herramienta libre basada en la web, Gantter \citep{gantter}.
