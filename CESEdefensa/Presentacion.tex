...
\begin{frame}{Motivación}{Motivación}
	...
	\end{itemize}
		\begin{figure}[H]
			{\includegraphics[width=.3\textwidth]{./imagenes/arquitectura}}
		\end{figure}	
%Es util y anda bien
...
%-------------------------------------------------%
\begin{frame}{Herramientas}{Nodo Mote LSE-FIUBA} 
...
%-------------------------------------------------%
\begin{frame}{Hardware}{El Panel Solar} 
...
\begin{minipage}[c]{1.0\linewidth}
	...
	\begin{minipage}[c]{0.4\linewidth}
		\begin{figure}[H]
			\includegraphics[width=1.1\textwidth]{./imagenes/panel.png}
			%\caption{Mote LSE}
		\end{figure}	  	  	
	\end{minipage}
\end{minipage}
...
\begin{frame}{Hardware}{Circuito de Extensión Cargador} 
		\begin{figure}[H]
...
\begin{frame}{Hardware}{Diagrama de Conexión} 
		\begin{figure}[H]
			\includegraphics[width=0.7\textwidth]{./imagenes/conex.png}
			%\caption{Mote LSE}
		\end{figure}	
\end{frame}
%-------------------------------------------------%
...
\begin{minipage}[c]{1.0\linewidth}
	\begin{minipage}[c]{0.4\linewidth}
	  ...
	  \begin{minipage}[c]{0.5\linewidth}
		\begin{figure}[H]
			{\includegraphics[width=1\textwidth]{./imagenes/arq.png}}
		\end{figure}	  	  	
	  \end{minipage}
\end{minipage}
